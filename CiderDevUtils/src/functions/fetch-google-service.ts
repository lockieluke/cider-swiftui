...
https.get('https://firebasestorage.googleapis.com/v0/b/cider-collective.appspot.com/o/GoogleService-Info-macOS.plist?alt=media&token=191e51ff-51b6-4e72-9d60-fb63e2aa828d', res => res.pipe(file).on('finish', () => spinner.succeed("Finished fetching GoogleService-Info.plist")))
